...
## Credentials
Two default profiles (admin and manager) unlock the inventory tools. Their passwords are stored as hashed values in browser st
orage. Administrators can create additional admin or manager profiles within the control panel.
